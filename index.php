          ...
          <div class="col-md-12">
            ...
            <select id="pretraga" class="form-control">
              ...
              foreach ($nizVrstiMuzike as $vm) {
                /*
                  ovde sam otisao do tabele i isao redom kroz id-eve i citao njegove vrednosti iz tabele
                */
              ?>
            ...
            <button id="pretrazi" class="form-control btn-info" onclick="pretrazi()">Pretrazi</button>
          </div>
          <hr>
