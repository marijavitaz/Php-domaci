        ...
        <div class="row justify-content-center text-center mb-5">
          ...
          <div class="col-md-12">
            ...
            <form method="POST" action="">
              ...
              <hr>
              <input type="submit" name="unos" class="form-control btn-info" value="Unesi lokal">
            </form>
            ...
            <form method="POST" action="">
              ...
              <hr>
              <input type="submit" name="izmena" class="form-control btn-info" value="Izmeni informacije o lokalu">
            </form>
            ...
            <form method="POST" action="">
              ...
              <hr>
              <input type="submit" name="obrisi" class="form-control btn-info" value="Obrisi lokal">
            </form>
